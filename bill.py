...
class Bill_App:
    def __init__(self,root):
        ...
        #====================Bill Search Button===============#
        bill_btn = Button(F1,text = "Enter",bd = 7,relief = GROOVE,font = ("times new roman",12,"bold"),bg = bg_color,fg = fg_color,command=self.enter)
        bill_btn.grid(row = 0,column = 6,ipady = 5,padx = 60,ipadx = 19,pady = 5)

        F2 = LabelFrame(self.root,text = 'Cosmetics',bd = 10,relief = GROOVE,bg = bg_color,fg = "red",font = ("times new roman",13,"bold"))
        ...
        F2 = LabelFrame(self.root,text = 'Grocery',bd = 10,relief = GROOVE,bg = bg_color,fg = "red",font = ("times new roman",13,"bold"))
        ...
        #======================
        exit_btn = Button(F4,text = "NEXT",bg = bg_color,fg = fg_color,font=("lucida",12,"bold"),bd = 7,relief = GROOVE,command=self.openw)
...
#Function to get total prices
    ...
    def enter(self):
          bill_no=self.c_bill_no.get()
          cust_name=self.cus_name.get()
          total_cosmetics=self.total_cosmetics.get()
          total_grocery=self.total_grocery.get()
          others_total=self.total_other.get()
          cosmetics_tax=self.tax_cos.get()
          grocery_tax=self.tax_groc.get()
          other_tax=self.tax_other.get()
          ...
          sql="insert into customer(bill_no,cust_name,total_cosmetics,total_grocery,others_total,cosmetics_tax,grocery_tax,other_tax) values (%s,%s,%s,%s,%s,%s,%s,%s)"
          val=(bill_no,cust_name,total_cosmetics,total_grocery,others_total,cosmetics_tax,grocery_tax,other_tax)
...
#Function For Text Area
    def welcome_soft(self):
        ...
        self.txt.insert(END,"       Welcome To shopping Retail\n")
